...
/***** functions area *****/
const checkViewport = (widthMAX, widthMIN, scroll, animations) => {
...
const AN6 = () => {
    ...
    infoProjectText === null || infoProjectText === void 0 ? void 0 : infoProjectText.classList.remove("pause");
};
/***** first run when load****/
AN2();
AN3();
...
const pages = [
    ...
    },
    {
        ...
        image: "assets/images/pages/adobe-color.jpg",
        title: "Adobe Color",
    ...
    },
    {
        ...
        image: "assets/images/pages/css-Gradient.jpg",
        title: "CSS Gradient",
    ...
    },
    {
        ...
        image: "assets/images/pages/UTOPIA_fluid_type_scale_calculator.jpg",
    ...
    },
    {
        ...
        image: "assets/images/pages/Autoprefixer.jpg",
        title: "Autoprefixer",
    ...
    },
    {
        ...
        image: "assets/images/pages/cssminifier.jpg",
    ...
    },
    {
        ...
        image: "assets/images/pages/cubic_bezier.jpg",
        title: "Cubic Bezier",
    ...
    },
    {
        ...
        image: "assets/images/pages/online_convert.jpg",
    ...
    },
    {
        ...
        image: "assets/images/pages/flaticon.jpg",
        title: "Flaticon",
    ...
    },
    {
        ...
        image: "assets/images/pages/favicon_generator.jpg",
    ...
    },
    {
        ...
        image: "assets/images/pages/google_fonts.jpg",
        title: "Google Fonts",
    ...
    },
    {
        ...
        image: "assets/images/pages/CSS_clip-path_maker_by_Bennett_Feely.jpg",
    ...
    },
    {
        ...
        image: "assets/images/pages/wave_generator_mini.jpg",
        title: "SVG Wave Generator",
        url: "https://getwaves.io/"
    }
];
/***** function area *****/
const nextORprevius = (imgPos, NP) => {
    if (slayerImageAN3 instanceof HTMLElement &&
        ...
        infoPages === null || infoPages === void 0 ? void 0 : infoPages.remove();
        /*** inject elements ***/
        let nextORpreviusPosition = imgPos;
        if (NP === "next")
            nextORpreviusPosition = imgPos - 1;
        else
            nextORpreviusPosition = imgPos + 1;
...
const numberOfPages = (imagePosition) => {
    // disappear left btn
    if (pages[imagePosition - 1]) {
        btnSlayerL === null || btnSlayerL === void 0 ? void 0 : btnSlayerL.classList.remove("none");
    }
    else {
        btnSlayerL === null || btnSlayerL === void 0 ? void 0 : btnSlayerL.classList.add("none");
    }
    // disappear right btn
    if (pages[imagePosition + 1]) {
        btnSlayerR === null || btnSlayerR === void 0 ? void 0 : btnSlayerR.classList.remove("none");
    }
    else {
        btnSlayerR === null || btnSlayerR === void 0 ? void 0 : btnSlayerR.classList.add("none");
    }
    // disappear both btn
    if (pages.length <= 1) {
        btnSlayerR === null || btnSlayerR === void 0 ? void 0 : btnSlayerR.classList.add("none");
...
/***** functions area *****/
const nextORpreviusProjects = (positionProject, nextProject) => {
    ...
    if (projects[PrevNext]) {
        ...
        containerImg === null || containerImg === void 0 ? void 0 : containerImg.append(img2);
    }
    containerImg === null || containerImg === void 0 ? void 0 : containerImg.append(img);
    /** title **/
    const title = d.createElement("H2");
    ...
    containerTitle === null || containerTitle === void 0 ? void 0 : containerTitle.append(title);
    if (projects[PrevNext]) {
        const title2 = d.createElement("H2");
        title2.classList.add("title-proyect");
        title2.classList.add("opacity-hidden");
        title2.textContent = projects[PrevNext].title;
        containerTitle === null || containerTitle === void 0 ? void 0 : containerTitle.append(title2);
    }
    /** description **/
    const text = d.createElement("div");
    text.classList.add("opacity-show");
    text.classList.add("text-project");
    if (textContainerProj)
        textContainerProj.innerHTML = "";
    if (projects[PrevNext]) {
        const text2 = d.createElement("div");
        text2.innerHTML = projects[PrevNext].text;
        text2.classList.add("opacity-hidden");
        text2.classList.add("text-project");
        textContainerProj === null || textContainerProj === void 0 ? void 0 : textContainerProj.append(text2);
    }
    text.innerHTML = "";
    text.innerHTML = projects[positionProject].text;
    textContainerProj === null || textContainerProj === void 0 ? void 0 : textContainerProj.append(text);
};
const numberOfProjects = (positionProject) => {
    // disappear left btn
    if (projects[positionProject - 1]) {
        previusProjectBTN === null || previusProjectBTN === void 0 ? void 0 : previusProjectBTN.classList.remove("none");
    }
    else {
        previusProjectBTN === null || previusProjectBTN === void 0 ? void 0 : previusProjectBTN.classList.add("none");
    }
    // disappear right btn
    if (projects[positionProject + 1]) {
        nextProjectBTN === null || nextProjectBTN === void 0 ? void 0 : nextProjectBTN.classList.remove("none");
    }
    else {
        nextProjectBTN === null || nextProjectBTN === void 0 ? void 0 : nextProjectBTN.classList.add("none");
    }
    // disappear both btn
...
const hideAN6InMovile = (isMovile) => {
    ...
    if (isMovile) {
        ...
        resurtAN5 === null || resurtAN5 === void 0 ? void 0 : resurtAN5.insertAdjacentElement("afterend", div2);
        resurtAN5 === null || resurtAN5 === void 0 ? void 0 : resurtAN5.append(div);
        resurtAN5 === null || resurtAN5 === void 0 ? void 0 : resurtAN5.append(div3);
    }
    else {
        ...
        if (contaienrTextInfoProj)
            projectArea === null || projectArea === void 0 ? void 0 : projectArea.append(contaienrTextInfoProj);
        const div = d.createElement("DIV");
        div.classList.add("info-projects");
        const div2 = d.createElement("DIV");
        div2.classList.add("container-title-proyect");
        contaienrTextInfoProj === null || contaienrTextInfoProj === void 0 ? void 0 : contaienrTextInfoProj.append(div2);
        contaienrTextInfoProj === null || contaienrTextInfoProj === void 0 ? void 0 : contaienrTextInfoProj.append(div);
    }
    nextORpreviusProjects(positionProject, "next");
};
/***** first run *****/
if (innerWidth > 1000)
    hideAN6InMovile(false);
else
    hideAN6InMovile(true);
if (cube && cube.children) {
    let cubeProject = Array.from(cube === null || cube === void 0 ? void 0 : cube.children);
...
/***** functions area  *****/
const changeColorTheme = (colorName) => {
...
// FUNCTIONS GLOBAL  /////////////////////////////////////////////////////////////////
function extractElementByClass(element, searchProblem) {
...
function extractElementById(element, searchProblem) {
    return d.querySelector(`#${element}`) instanceof HTMLElement
        ? d.querySelector(`#${element}`)
...
d.addEventListener("animationend", (e) => {
    if (e.target.matches(".text-container-AN2")) {
    ...
    if (e.target instanceof Element) {
        ...
        if (Target === nextProjectBTN) {
            if (pages[positionProject + 1]) {
                positionProject += 1;
                cube === null || cube === void 0 ? void 0 : cube.classList.remove(`rotate-${positionProject - 1}`);
                cube === null || cube === void 0 ? void 0 : cube.classList.add(`rotate-${positionProject}`);
                numberOfProjects(positionProject);
                nextORpreviusProjects(positionProject, "next");
            }
        }
        ...
        if (Target.matches(".icon-color")) {
            containerThemeColor === null || containerThemeColor === void 0 ? void 0 : containerThemeColor.classList.toggle("show-theme");
        }
